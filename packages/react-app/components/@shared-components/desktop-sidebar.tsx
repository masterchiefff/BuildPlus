      ...
      <nav className="flex-1 p-4">
        <ul className="space-y-2">
          <li>
            <Link
              href="/"
              className={`w-full flex items-center p-2 rounded-lg ${activeTab === "home" ? "bg-indigo-600 text-white" : "text-gray-300 hover:bg-gray-800"}`}
          ...
          <li>
            <Link
              href="/explore"
              className={`w-full flex items-center p-2 rounded-lg ${activeTab === "explore" ? "bg-indigo-600 text-white" : "text-gray-300 hover:bg-gray-800"}`}
          ...
          <li>
            <Link
              href="/wallet"
              className={`w-full flex items-center p-2 rounded-lg ${activeTab === "wallet" ? "bg-indigo-600 text-white" : "text-gray-300 hover:bg-gray-800"}`}
          ...
          <li>
            <Link
              href="/create"
              className={`w-full flex items-center p-2 rounded-lg ${activeTab === "create" ? "bg-indigo-600 text-white" : "text-gray-300 hover:bg-gray-800"}`}
          ...
          <li>
            <Link
              href="/settings"
              className={`w-full flex items-center p-2 rounded-lg ${activeTab === "settings" ? "bg-indigo-600 text-white" : "text-gray-300 hover:bg-gray-800"}`}
      ...
      <div className="p-4 border-t border-gray-800">
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400">MiniPay Connected</p>
          </div>
        </div>
      </div>
    </div>
